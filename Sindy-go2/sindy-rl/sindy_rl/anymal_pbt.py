...
if __name__ == '__main__': 
    ...
    from sindy_rl.policy import CrocoddylPolicy, RandomPolicy
    ...
    filename = os.path.join(_parent_dir, 
                            'sindy_rl',
                            'config_templates', 
                            'anymal_sindy.yml' # replace with appropriate config yaml
                            )
    ...
    # you can choose the policy you want here
    dyna_config['off_policy_pi'] = CrocoddylPolicy()
